<%-- 
    Document   : discountpage_users
    Created on : 12-Sep-2018, 12:23:43 PM
    Author     : shagungoel
--%>
      ...
      PreparedStatement  st =con.prepareStatement("select * from Admin_Blog ");
       ...
       ResultSet rs = st.executeQuery();%>
        ...
        <%    while(rs.next()){
            ...
            <p >SERVICES OFFERED:: <%out.println(s2);%></p><br/>
            <h2>Discounts --><%out.println(s4);%> </h2>
            <h2>Discounts start from--><%out.println(s5);%> </h2><h2>lasts upto --><%out.println(s6);%> </h2>
       
            
            <a href="Hotelbookingform" class="linkbutton">Book Now</a>
            </fieldset>
            </div>
            </div> 
